...
public class ActivityListController {
    ...
    public ResponseEntity<ApiResponse<?>> getActivityList( @Valid @ModelAttribute ActivitySearchDto activitySearchDto ){
        log.info("모임목록조회 - query변수 : categoryId={}, 정렬조건={}", activitySearchDto.getCategoryId(), activitySearchDto.getSort());
        ActivityListDto activityListDto = activityService.readActivityList(activitySearchDto);
